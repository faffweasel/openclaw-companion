#!/bin/bash
# Stamp today's memory file to mark morning routine as complete.
...
echo "" >> "$MEMORY_FILE"
echo "Morning message sent: ${TIME} ${TZ:-UTC}" >> "$MEMORY_FILE"
echo "Stamped: Morning message sent at ${TIME}"
